(() => {
  ...
  const panelStyle = `section{background:#05070b!important;color:#edf0f6!important;border:1px solid #1d3a5e!important;border-radius:14px!important;box-shadow:0 12px 40px #0008,0 0 24px #1e7bff25!important;max-height:75vh;overflow:auto;font:13px system-ui!important;padding:22px!important}strong{display:block;font-size:16px;letter-spacing:-.3px}p{line-height:1.65}#summary{color:#b6c0cc;font-size:12px;padding-bottom:12px;border-bottom:1px solid #1f2a38}input{background:#0d121a;color:#edf0f6;border:1px solid #232d3b;border-radius:7px;padding:10px!important}button{border:1px solid #2a3544;border-radius:7px;background:#111823;color:#edf0f6;font:12px system-ui;padding:10px 14px!important}#start{background:linear-gradient(135deg,#1560f0,#1e8cff)!important;color:#fff!important;border-color:#2e8bff!important;font-weight:650}button:disabled{opacity:.45;cursor:not-allowed}a{color:#4db3ff}li{margin:12px 0;font-size:12px;line-height:1.6}[role=status]{padding:12px;background:#0b1a2c;border:1px solid #1d3a5e;border-radius:8px;color:#7cc4ff}`;
